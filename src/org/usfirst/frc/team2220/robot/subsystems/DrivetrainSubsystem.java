...
public class DrivetrainSubsystem extends Subsystem{
	...
	public void incrementRPosition(double x)
	{
		...
		System.out.println(rDriveMotorSetpoint);
	}
	...
	*/
	...
	//return Math.abs(lDriveMaster.getSelectedSensorPosition(0) + rDriveMaster.getSelectedSensorPosition(0)) / 2 > Robot.oi.finalTick;
	}
